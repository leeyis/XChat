...
fn main() {
    ...
    let app = builder
        .invoke_handler(tauri::generate_handler![
            ...
            lanchat::commands::refresh_peer_connection,
            lanchat::commands::rediscover_peers,
            ...
            lanchat::commands::open_camera_capture,
            lanchat::commands::start_voice_recording,
            lanchat::commands::stop_voice_recording,
